    ...
    <div className="!p-6">
      ...
      {products.length > 0 ? (
        <div className="overflow-x-auto">
          <table className="min-w-full border rounded-lg text-center bg-red-50">
            <thead>
              <tr className="border-b">
                <th className="!p-3 border-r border-gray-300">Product</th>
                <th className="!p-3 border-r border-gray-300">Status</th>
                <th className="!p-3 border-r border-gray-300">Product ID</th>
                ...
                <tr key={product.id} className="border-b">
                  ...
                  <td className="!p-3 border-r border-gray-300 font-semibold">
                    {product.status === "In stock" ? (
                      ...
                      <p className="text-red-400 line-through">Out of stock</p>
                    )}
                  </td>
