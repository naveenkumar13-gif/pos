...
export default function SettingsSidebar({ activeSection, onSectionChange, onPhotoEdit }: SettingsSidebarProps) {
  const sections = [
  ...
  return (
    <div className="w-80 bg-background border-r min-h-screen p-6">
      ...
      <Card className="p-6 mb-6 text-center">
        <div className="relative inline-block mb-4">
          <Avatar className="w-24 h-24">
            <AvatarImage src={profilePhoto} alt="Soul Man" />
      ...
      <div className="absolute bottom-6 left-6">
        <Button size="icon" variant="outline" className="rounded-full bg-destructive text-destructive-foreground">
